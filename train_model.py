...
def main(args):
    ...
    #create the smdbebug hook and register to the model.
    ...
    hook.register_loss(criterion) #Set Hook to track the loss 
    ...
    #pass hook in the epoch loop for train and test functions.
